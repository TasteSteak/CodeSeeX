...
const RESERVED_CONFIG_KEYS: &[&str] = &[
    ...
    "BILLING_VISION_CACHED_INPUT_CNY",
    "BILLING_VISION_CACHE_MISS_INPUT_CNY",
    "BILLING_VISION_OUTPUT_CNY",
    "CATALOG_MODE",
    "DEEPSEEK_API_KEY",
    ...
    "VISION_ANALYZE_URL",
    "VISION_ANALYZE_BACKEND",
    "VISION_ANALYZE_API_KEY",
    "VISION_IMAGE_DETAIL",
    "VISION_GENERATE_MODEL",
    "VISION_GENERATE_URL",
    "VISION_GENERATE_API_KEY",
    "VISION_API_KEY",
];
